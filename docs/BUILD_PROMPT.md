...
> **Status:** Prompts 0–5 are done, and the v1.1 items (transitions, ear training) with
> them — 109 tests, detector at 97.8 % true-accept / 0 % false-accept on synthetic audio.
>
> **The next step is not a prompt.** It is recording real fixtures and playing a session
> with a ukulele in your hands. Every number in this repo comes from synthesised audio, and
> nothing here has been heard by a microphone.
